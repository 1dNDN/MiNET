		...
		public override Block[] Blocks
		{
			get
			{
				return new[]
				{
					...
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-2, 5, 1),
						Metadata = 3
					},
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-2, 5, 0),
						Metadata = 3
					},
					new Block(18)
					{
					...
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-2, 5, -2),
						Metadata = 3
					},
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-1, 5, 2),
						Metadata = 3
					},
					new Block(18)
					{
					...
					new Block(18)
					{
						Coordinates = new BlockCoordinates(0, 5, 2),
						Metadata = 3
					},
					new Block(18)
					{
					...
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-1, 6, 1),
						Metadata = 3
					},
					new Block(18)
					{
					...
					new Block(18)
					{
						Coordinates = new BlockCoordinates(-1, 7, 0),
						Metadata = 3
					},
					new Block(18)
					{
						Coordinates = new BlockCoordinates(0, 7, 1),
						Metadata = 3
					},
					new Block(18)
					{
						Coordinates = new BlockCoordinates(0, 7, 0),
						Metadata = 3
					},
					new Block(18)
					{
